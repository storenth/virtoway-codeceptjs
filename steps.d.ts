...
type ICodeceptCallback = (i: CodeceptJS.I, mainPage:CodeceptJS.mainPage, cartPage:CodeceptJS.cartPage, checkoutPage:CodeceptJS.checkoutPage) => void;
...
declare namespace CodeceptJS {
  ...
  export interface mainPage {
    chooseMobile(mobileName: string) : void,
    addToCart() : void,
  ...
  export interface checkoutPage {
    fillCustomerInfo(mobileName: string) : void,
    getTotalPrice() : void,
